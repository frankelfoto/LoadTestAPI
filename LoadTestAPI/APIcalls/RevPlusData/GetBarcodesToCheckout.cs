namespace RevPlusAPI
{
    ...
    public class GetBarcodesToCheckoutCoded : WebTest
    {
        string sUri = "GetBarcodesToCheckout";
        ...
        public static string sTransferOrderId = "0";
        public int iThinkTime = helper.iThinkTime;
        public GetBarcodesToCheckoutCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            string uri = (Context["WebServer"].ToString() + Context["URI"].ToString()) + "/" + sOrderId + "/" + sTransferOrderId;
