namespace RevPlusAPI
{
    ...
    public class GetLocationByIdCoded : WebTest
    {
        string sUri = "GetLocationById";
		...
		public string sLocationId = "1";
        public int iThinkTime = helper.iThinkTime;
        public GetLocationByIdCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            string uri = (Context["WebServer"].ToString() + Context["URI"].ToString() + "/" + sLocationId);
