namespace RevPlusAPI
{
    ...
    public class GetLocationInactiveValidationByLocationIdCoded : WebTest
    {
        string sUri = "GetLocationInactiveValidationByLocationId";
        ...
        public GetLocationInactiveValidationByLocationIdCoded()
        {
