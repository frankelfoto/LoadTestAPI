namespace RevPlusAPI
{
    ...
    public class GetUserByCredentialsCoded : WebTest
    {
        string sUri = "GetUserByCredentials";
        ...
        public static string sPassword = helper.randomPassword(x);
        public int iThinkTime = helper.iThinkTime;
        public GetUserByCredentialsCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            string uri = (Context["WebServer"].ToString() + Context["URI"].ToString()) + "/" + sUserId + "/" + sPassword;
