namespace RevPlusAPI
{
    ...
    public class GetQuickCheckoutWithStatusMsgIdCoded : WebTest
    {
        public string sMethod = "GET";
        public string sUri = "GetQuickCheckoutWithStatusMsgId";
        ...
        public string sStatusMsgId = "984765";
        public int iThinkTime = helper.iThinkTime;

        public GetQuickCheckoutWithStatusMsgIdCoded()
        {
