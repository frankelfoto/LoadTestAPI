namespace RevPlusAPI
{
    ...
    public class GetTransferNoteByTransferOrderIdCoded : WebTest
    {
        public string sMethod = "GET";
        public string sUri = "GetTransferNoteByTransferOrderId";
        ...
        public static string sTransferOrderId = (helper.randomInt(0, 1000)).ToString();
        public int iThinkTime = helper.iThinkTime;
        public GetTransferNoteByTransferOrderIdCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            string uri = (Context["WebServer"].ToString() + Context["URI"].ToString()) + "/" + sTransferOrderId;
