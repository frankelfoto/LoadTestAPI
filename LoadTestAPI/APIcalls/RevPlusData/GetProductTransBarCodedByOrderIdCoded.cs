namespace RevPlusAPI
{
    ...
    public class GetProductTransBarCodedByOrderIdCoded : WebTest
    {
        // GetProductTransMasterItemsToCheckIn/9372384/false HTTP/1.1

        public string sMethod = "GET";
        public string sUri = "GetProductTransBarCodedByOrderId";
        ...
        public GetProductTransBarCodedByOrderIdCoded()
        {
